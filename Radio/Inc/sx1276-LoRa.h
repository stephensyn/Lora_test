...
typedef struct sLoRaSettings
{
    ...
    //新增LORA同步字
    uint8_t SyncWordValue;        // LORA [0x34: 868 MHz, 0x12: 433 MHz, 0x18: 780 MHz, 0x24: 470 MHz, 0x34: 868 MHz]
} tLoRaSettings;
...
typedef struct sSX1276LR
{
    ...
    //新增RegSyncWord
    uint8_t RegSyncWord; // 0x39 REGSYNCWORD
...
/*!
 * \brief Enten CAD mode of the SX1276
 *
 * \param [IN]: state in 
 */
...
/*!
 * \brief Sets the SX1276 parameter changes
 *
